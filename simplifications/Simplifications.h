...
class Simplifications {
    public:
        ...
        static void removeUselessAttrNoDisjunction(std::vector<HyperBlock>& hyper_blocks, std::vector<std::vector<std::vector<float>>>& data, std::vector<std::vector<int>>& attributeOrderings);
};
