...
__global__ void removeUselessAttributes(float* mins, float* maxes, const int minMaxLen, const int numBlocks, const int* blockClasses, char* attrRemoveFlags, const int fieldLen, const float* dataset, const int numPoints, const int* classBorder, const int numClasses, const int *attributeOrder);
